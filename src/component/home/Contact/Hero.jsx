      ...
      <section>
        <div className="relative w-full h-[40vh] lg:h-[50vh] lg:w-full object-contain">
          <img
            ...
            alt="ttt"
          />
          <div className="absolute bg-black/60 top-0 w-full lg:h-cover h-full lg:h-[80vh] text-white pt-28 lg:pt-36 px-5 lg:px-28 lg:flex lg:justify-between font-cabin">
            <div>
              <p className="text-4xl lg:text-6xl font-semibold">{t("Contact")}</p>
            </div>
